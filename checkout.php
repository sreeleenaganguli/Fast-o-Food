...
<head>
    ...
    <link rel="icon" href="#">
    <title>Checkout || Fast-o-Food</title>
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo_1.png" alt="" width="18%"> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
						...
						if(empty($_SESSION["user_id"]))
							{
								echo '<li class="nav-item"><a href="admin/index.php" class="nav-link active">Admin</a> </li>
                                            ...
                                            <ul class=" list-unstyled">
                                                ...
                                                <li>
                                                    <label class="custom-control custom-radio  m-b-10">
                                                        <input name="mod" type="radio" value="paypal" disabled class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Paypal <img src="images/gpay.jpg" alt="" width="90"></span> </label>
                                                </li>
                                            </ul>
